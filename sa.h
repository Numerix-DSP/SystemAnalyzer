...
#define SA_COPYRIGHT_NOTICE				"SA Version 1.91. (c) 2002 to 2017 Numerix Ltd."
#define SA_ID							"23/07/2017 V1.92"
#define SA_VERSION						"1.92"
...
{
public:
	DisplayTextDialog (wxFrame *parent, wxWindowID id, const wxString &title,
