...
#define DEBUG_IO      1   // Set to '1' to enable debug file logging

// Select desired audio interface - searches for these sub-strings

// #define DESIRED_AUDIO_INPUT_INTERFACE       "Line In (BEHRINGER USB WDM AUDIO 2.8.40)"
// #define DESIRED_AUDIO_OUTPUT_INTERFACE      "Speakers (BEHRINGER USB WDM AUDIO 2.8.40)"
// #define DESIRED_AUDIO_INPUT_API             "Windows DirectSound"
// #define DESIRED_AUDIO_OUTPUT_API            "Windows DirectSound"
// #define DESIRED_AUDIO_INPUT_API             "Windows WASAPI"
// #define DESIRED_AUDIO_OUTPUT_API            "Windows WASAPI"

// #define DESIRED_AUDIO_INPUT_INTERFACE       "Line In (BEHRINGER USB AUDIO)"
// #define DESIRED_AUDIO_OUTPUT_INTERFACE      "Speakers (BEHRINGER USB AUDIO)"
// #define DESIRED_AUDIO_INPUT_API             "Windows WDM-KS"
// #define DESIRED_AUDIO_OUTPUT_API            "Windows WDM-KS"
...
// #define DESIRED_AUDIO_INPUT_API             "MME"
// #define DESIRED_AUDIO_OUTPUT_API            "MME"
// #define DESIRED_AUDIO_INPUT_API             "Windows WASAPI"
// #define DESIRED_AUDIO_OUTPUT_API            "Windows WASAPI"
// #define DESIRED_AUDIO_INPUT_API             "Windows DirectSound"
// #define DESIRED_AUDIO_OUTPUT_API            "Windows DirectSound"

// #define DESIRED_AUDIO_INPUT_INTERFACE       "ASIO4ALL v2"             // UCA202 - ASIO
// #define DESIRED_AUDIO_OUTPUT_INTERFACE      "ASIO4ALL v2"             // UCA202 - ASIO
// #define DESIRED_AUDIO_INPUT_API             "ASIO"
// #define DESIRED_AUDIO_OUTPUT_API            "ASIO"

// #define DESIRED_AUDIO_INPUT_INTERFACE       "Line (3- XMOS XS1-U8 DJ)"
// #define DESIRED_AUDIO_OUTPUT_INTERFACE      "Speakers (3- XMOS XS1-U8 DJ)"
// #define DESIRED_AUDIO_INPUT_API             "MME"
// #define DESIRED_AUDIO_OUTPUT_API            "MME"

// #define DESIRED_AUDIO_INPUT_INTERFACE       "xCORE USB Audio 1.0  (3- xCORE USB Audio 1.0)"      // "XMOS XS1-L1"
// #define DESIRED_AUDIO_OUTPUT_INTERFACE      "Speakers (3- xCORE USB Audio 1.0)"                  // "XMOS XS1-L1"
// #define DESIRED_AUDIO_INPUT_API             "Windows DirectSound"
// #define DESIRED_AUDIO_OUTPUT_API            "Windows DirectSound"

// #define DESIRED_AUDIO_INPUT_INTERFACE       "xCORE USB Audio 1.0  (3- xCORE "           // "XMOS XS1-L1"
// #define DESIRED_AUDIO_OUTPUT_INTERFACE      "Speakers (3- xCORE USB Audio 1."           // "XMOS XS1-L1"
// #define DESIRED_AUDIO_INPUT_API             "MME"
// #define DESIRED_AUDIO_OUTPUT_API            "MME"

// // // #define DESIRED_AUDIO_INPUT_INTERFACE       "xCORE USB Audio 1"           // "XMOS XS1-L1"
// // // #define DESIRED_AUDIO_OUTPUT_INTERFACE      "xCORE USB Audio 1"           // "XMOS XS1-L1"
// // // #define DESIRED_AUDIO_INPUT_API             "MME"
// // // #define DESIRED_AUDIO_OUTPUT_API            "MME"

// #define DESIRED_AUDIO_INPUT_INTERFACE       "TUSBAudio ASIO Driver"           // "TUSBAudio ASIO Driver"
// #define DESIRED_AUDIO_OUTPUT_INTERFACE      "TUSBAudio ASIO Driver"           // "TUSBAudio ASIO Driver"
// #define DESIRED_AUDIO_INPUT_API             "ASIO"
// #define DESIRED_AUDIO_OUTPUT_API            "ASIO"

//                                              // Behringer UCA202 Windows 10
...
/* Declare functions */
long SampleAudio (double *pInputData, long DataLength);
long SampleAndGenerateAudio (double *pInputData, double *pOutputData, long DataLength);
long CalibrateAudio (double *pInputData, double *pOutputData, long DataLength, long CalThreshold);
void error_terminate (PaError err);
...

{
    ...
    wxBoxSizer *HSizer_CalLevelP = new wxBoxSizer (wxHORIZONTAL); wxBoxSizer *HSizer_CalLevelPP = new wxBoxSizer (wxHORIZONTAL);
    ...
    VSizer->Add (HSizer_CalLevelP, 0, wxALIGN_LEFT | wxALL, 2); VSizer->Add (HSizer_CalLevelPP, 0, wxALIGN_LEFT | wxALL, 2);
    ...
    ProcessingTypeComboBox = new wxComboBox (this, ID_EVENT_TYPE_CHANGED, wxEmptyString, wxDefaultPosition, wxDefaultSize,
                                            WXSIZEOF (FilterChoices), FilterChoices, wxCB_READONLY);
    ProcessingTypeComboBox->SetSelection (0);   // Set the default selection
    HSizer_AnalysisType->Add (ProcessingTypeComboBox, 0, wxALIGN_LEFT | wxALL, 0);
    ...
    DataSetSizeSpinCtrl = new wxSpinCtrl (this, ID_EVENT_TD_DATASET_SIZE_SPIN_CHANGED, _T(""),
                                          wxDefaultPosition,wxDefaultSize,
                                          wxSP_ARROW_KEYS, 10, MAXIMUM_GRAPH_WIDTH, 0);
    DataSetSizeSpinCtrl->SetValue (512);
    DataSetSizeSpinCtrl->Enable (TRUE);
    HSizer_TDDataSetSize->Add (DataSetSizeSpinCtrl, 0, wxALIGN_LEFT | wxALL, 0);
    ...
    HSizer_TimeTrigEnable->Add (TriggerLED = new LED (this, -1, GREEN_LED), 0, wxALIGN_TOP | wxALIGN_LEFT | wxALL, 0); //, 5);
    TriggerLED->On (FALSE);
    ...
    TimeTriggerPositiveRadioButton = new wxRadioButton (this, ID_EVENT_TIME_TRIG_POS_RADIOBUTTON, _T("&Positive"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    ...
    HSizer_TimeTrigDir->Add (TimeTriggerPositiveRadioButton, 0, wxALIGN_LEFT | wxALL, 0);
    HSizer_TimeTrigDir->Add (TimeTriggerNegativeRadioButton, 0, wxALIGN_LEFT | wxALL, 0);
    ...
    TimeTriggerLevelSpinCtrl = new wxSpinCtrl (this, ID_EVENT_TRIG_LEVEL_SPIN_CHANGED, _T(""),
                                            wxDefaultPosition, wxDefaultSize,
                                            wxSP_ARROW_KEYS, 0, 32, 0);
    TimeTriggerLevelSpinCtrl->SetValue (1);
    TimeTriggerLevelSpinCtrl->Enable (TRUE);
    HSizer_TimeTrigLevel->Add (TimeTriggerLevelSpinCtrl, 0, wxALIGN_LEFT | wxALL, 0);
    ...
    FFTOnePoleSpinCtrl = new wxSpinCtrl (this, ID_EVENT_ONE_POLE_SPIN_CHANGED, _T(""),
                                        wxDefaultPosition, wxDefaultSize,
                                        wxSP_ARROW_KEYS, 0, 99, 0);
    FFTOnePoleSpinCtrl->SetValue (0);
    FFTOnePoleSpinCtrl->Enable (FALSE);
    HSizer_FFTOnePoleAlpha->Add (FFTOnePoleSpinCtrl, 0, wxALIGN_LEFT | wxALL, 0);
#if SIGLIB
    ...
    FFTPeakHoldSpinCtrl = new wxSpinCtrl (this, ID_EVENT_PEAK_HOLD_SPIN_CHANGED, _T(""),
                                        wxDefaultPosition, wxDefaultSize,
                                        wxSP_ARROW_KEYS, 0, 99, 0);
    FFTPeakHoldSpinCtrl->SetValue (0);
    FFTPeakHoldSpinCtrl->Enable (FALSE);
    HSizer_FFTPeakHoldAlpha->Add (FFTPeakHoldSpinCtrl, 0, wxALIGN_LEFT | wxALL, 0);
#if SIGLIB
    ...
    HSizer_CalcButton->Add (CalculateButton, 0, wxALIGN_CENTER | wxALL, 0);
    ...
    HSizer_CalLevel->Add (CalTholdSpinCtrl, 0, wxALIGN_LEFT | wxALL, 0);

    // This button calibrates the I/O
    wxButton *CalibrateButton = new wxButton(this, ID_EVENT_CALIBRATE, "Calibrate");
    HSizer_CalButton->Add (CalibrateButton, 0, wxALIGN_CENTER | wxALL, 0);
...
void SAProcWindow::OnDataSetSizeSpinControlChange (wxSpinEvent& WXUNUSED(event))
...
void SAProcWindow::OnTriggerLevelSpinControlChange (wxSpinEvent& WXUNUSED(event))
...
void SAProcWindow::OnOnePoleFilterSpinControlChange (wxSpinEvent& WXUNUSED(event))
...
void SAProcWindow::OnPeakHoldSpinControlChange (wxSpinEvent& WXUNUSED(event))
...
void SAProcWindow::OnTypeChanged (wxCommandEvent& WXUNUSED(event))

{
    ...
    else    // ID_PROC_CHIRP_TIME, ID_PROC_CHIRP_FREQ, ID_PROC_CHIRP_XCORR
    {
        DataSetSizeSpinCtrl->Enable (TRUE);
        TimeTriggerEnableCheckBox->Enable (FALSE);
        TimeTriggerLevelSpinCtrl->Enable (FALSE);
...
void SAProcWindow::OnProcessData (wxCommandEvent& WXUNUSED(event))
            ...
            (ProcessingTypeComboBox->GetSelection () == ID_PROC_TIME_CONT))
    {
        ...
        if (TimeTriggerEnableCheckBox->GetValue () == TRUE)
        {
            if (TimeTriggerPositiveRadioButton->GetValue () == TRUE)  // Positive slope
            {
                ...
                TriggerLocation = SDA_Trigger (pFDPRealData, &ZXPrevSign, 1000.0 * (SLData_t)TimeTriggerLevelSpinCtrl->GetValue(),
                SIGLIB_POSITIVE_LEVEL_CROSS, SAMPLE_LENGTH);
            }
            else                            // Negative slope
            {
                ZXPrevSign = SIGLIB_NEGATIVE;             // Only processing individual arrays
                TriggerLocation = SDA_Trigger (pFDPRealData, &ZXPrevSign, 1000.0 * (SLData_t)TimeTriggerLevelSpinCtrl->GetValue(),
                SIGLIB_NEGATIVE_LEVEL_CROSS, SAMPLE_LENGTH);
            }
...
#else
        wxMessageBox ("This functionality is only available when SigLib is installed\nFor more details, please see http://www.numerix-dsp.com", "System Analyzer", wxOK | wxICON_EXCLAMATION, NULL);
#endif
    }
...
void SAProcWindow::OnCalibrateIO (wxCommandEvent& WXUNUSED(event))
...
void SAProcWindow::SetSampleRate (double sampleRate)
{
    SampleRate = sampleRate;
}


void SAProcWindow::SetDataArray (double * pDataArray)
{
    pData = pDataArray;
}

void SAProcWindow::OnIdle (wxIdleEvent& WXUNUSED(event))
...
#if DEBUG_IO
        SUF_Debugfprintf ("SampleAudio - Device %d = %s, inputs = %d, outputs = %d, Host API = %s\n", (int)i, deviceInfo->name, (int)deviceInfo->maxInputChannels, (int)deviceInfo->maxOutputChannels,  Pa_GetHostApiInfo( deviceInfo->hostApi )->name);
#endif

        //    if ((strcmp(deviceInfo->name, DESIRED_AUDIO_INPUT_INTERFACE) == 0) && (strcmp(Pa_GetHostApiInfo( deviceInfo->hostApi )->name, DESIRED_AUDIO_INPUT_API) == 0) && (deviceInfo->maxInputChannels != 0))
        if ((strstr(deviceInfo->name, DESIRED_AUDIO_INPUT_INTERFACE) != 0) && (strcmp(Pa_GetHostApiInfo( deviceInfo->hostApi )->name, DESIRED_AUDIO_INPUT_API) == 0) && (deviceInfo->maxInputChannels != 0))
        {
            InputDeviceNo = i;
        }
        //    if ((strcmp(deviceInfo->name, DESIRED_AUDIO_OUTPUT_INTERFACE) == 0) && (strcmp(Pa_GetHostApiInfo( deviceInfo->hostApi )->name, DESIRED_AUDIO_OUTPUT_API) == 0) && (deviceInfo->maxOutputChannels != 0))
        if ((strstr(deviceInfo->name, DESIRED_AUDIO_OUTPUT_INTERFACE) != 0) && (strcmp(Pa_GetHostApiInfo( deviceInfo->hostApi )->name, DESIRED_AUDIO_OUTPUT_API) == 0) && (deviceInfo->maxOutputChannels != 0))
        {
            OutputDeviceNo = i;
        }
    }
...

{
    ...
    //  static int ZeroSampleTimeOffset = 6050+PREAMBLE_LENGTH;
    //  static int ZeroSampleTimeOffset = 0;
    //  static int ZeroSampleTimeOffset = 7200;
    //  static int ZeroSampleTimeOffset = 8380;     // Vaio
    //  static int ZeroSampleTimeOffset = 7519;     // Dell

    for (i = 0; i < DataLength; i++)        /* Save input data for calling function */
    {
        //    *(pInputData+i) = (double)IOData.pCh0InputSamples[i+ZeroSampleTimeOffset];
        *(pInputData+i) = (double)IOData.pCh0InputSamples[i+IODelay];
    }

    //  ZeroSampleTimeOffset += 400;
...

{
    ...
    {
#if DEBUG_IO
        SUF_Debugfprintf ("CalibrateAudio - Error starting stream\n");
#endif
        error_terminate (err);
        return (1);
    }
    ...
    // Calculate I/O delay
    //  for (i = PREAMBLE_LENGTH; i < PREAMBLE_LENGTH + PA_SAMPLE_LENGTH + POSTAMBLE_LENGTH; i++)
    for (i = 0; i < PREAMBLE_LENGTH + PA_SAMPLE_LENGTH + POSTAMBLE_LENGTH; i++)
    {
        //    if (abs (IOData.pCh0InputSamples[i]) > 50)
        //    if (abs (IOData.pCh0InputSamples[i]) > 500)
